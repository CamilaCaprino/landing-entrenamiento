        ...
        <div className="grid lg:grid-cols-2 items-center">
          ...
          >
            <p className="sm:text-28 text-18 text-muted mb-4">
              Pasión y <span className="text-primary">Conocimiento</span>
            </p>
            <h2 className="text-white sm:text-40 text-30 mb-4 font-medium">
              Diseñamos planes de precisión que se adaptan a tu ritmo, garantizando una disciplina constante en cada fase de tu 
              <span className="text-primary"> transformación.</span>
            </h2>
            <p className="text-muted text-opacity-60 text-18">
              Nuestra metodología combina tecnología de precisión con 
              <br className="md:block hidden" /> los valores fundamentales del deporte para asegurar tu éxito.
            </p>
