        ...
        <div ref={ref} className="grid grid-cols-12 items-center">
          ...
          >
            <p className="sm:text-28 text-18 text-white">
              Optimiza tu potencial: Empecemos <span className="text-primary">hoy mismo</span>
            </p>
            <h2 className="sm:text-40 text-30 text-white lg:w-full md:w-70% font-medium">
              Te acompaño en la optimización de tu rendimiento deportivo y bienestar general para alcanzar tus metas de forma integral.
            </h2>
