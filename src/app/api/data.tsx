...
export const upgradeData: { title: string }[] = [
 ...
 // { title: "Convertí esfuerzo en resultados" },
  { title: "Mejora fuerza y técnica" },
];
...
export const perksData = [
  {
    ...
    text: "Seguimiento constante para ayudarte a entrenar mejor y progresar en cada etapa.",
    space: "lg:mt-8",
  },
  {
    icon: "/images/perks/icon-community.svg",
    title: "Equipo",
    text: "Entrená en un entorno que motiva, acompaña y potencia tu rendimiento.",
    space: "lg:mt-14",
  },
  {
    icon: "/images/perks/icon-academy.svg",
    title: "Metodología",
    text: "Entrenamientos planificados con objetivos claros y resultados medibles.",
    space: "lg:mt-4",
  },
];
